            ...
            <Card.Header>
              <div className="mt-2 me-2 mb-2 d-flex">
                <Dropdown className="d-inline mx-5">
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item
                      onClick={() => seriesHandler("Premier League")}
                    >
                      Premier League
                    </Dropdown.Item>
                    <Dropdown.Item
                      onClick={() => seriesHandler("Cup - Round of 32")}
                    >
                      Cup - Round of 32
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => seriesHandler("All")}>
                      All
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => seriesHandler("Other")}>
                      Other
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
                ...
                <Dropdown className="d-inline mx-5" align="end">
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item onClick={() => seasonHandler("2022")}>
                      2022
                    </Dropdown.Item>
                    <Dropdown.Item onClick={() => seasonHandler("2021/2022")}>
                      2021/2022
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>

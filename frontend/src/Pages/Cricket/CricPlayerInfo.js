      ...
      <div className="container">
        <table>
          <tr>
            <th>
              <img
                src={prop.location.state.e.img}
                class="rounded float-left"
                alt="..."
              ></img>
            </th>
            <th>
              <h1>{prop.location.state.e.pname}</h1>(India)
            </th>
          </tr>
        </table>
        <Row>
          ...
          <Col sm={12} md={6}>
            ...
            <p>
              ...
              in early 2008. In an Indian team filled with saint-like icons
              worthy of their own hagiographies, Virat Kohli, with his most
              un-Indian, 'bad-boy' intensity, would clearly be an outcast. . In
              the aplayeept Kohli out of the team
            </p>
          </Col>
        </Row>
        <Card

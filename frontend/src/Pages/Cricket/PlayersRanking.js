  ...
  return (
    <>
      ...
      <div className="container">
        {
          <Card
            className="mx-auto, w-100 ,my-auto mt-2 mb-2"
          ...
          >
            <Card.Header style={{ backgroundColor: "#696D97" }}>
              ...
              <Nav
                variant="pills"
                defaultActiveKey="/PlayerRanking"
                className="py-2"
              >
                <Nav.Item>
              ...
              <Row>
                <Col xs={9} md={7}>
                  <table className="table mt-2" style={{ color: "white" }}>
                    ...
                    <tr>
                      ...
                      <td>
                        <img
                          src="https://www.cricbuzz.com/a/img/v1/50x50/i1/c184115/marnus-labuschagne.jpg"
                          alt="img"
                        ></img>
                      </td>
                      <td>
                        <a href="/">
                          <h4>Marnus Labuschagne</h4>
                        </a>
                        (Australia)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <img
                          src="https://www.cricbuzz.com/a/img/v1/50x50/i1/c170658/rohit-sharma.jpg"
                          alt="img"
                        ></img>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <img
                          src="https://www.cricbuzz.com/a/img/v1/50x50/i1/c170661/virat-kohli.jpg"
                          alt="img"
                        ></img>
                      </td>
                      <td>
                ...
                <Col xs={3} md={5}>
                  <Card style={{ backgroundColor: "#3F4156" }}>
                    <p className="text-center">Ad section</p>
                  </Card>
                </Col>
              </Row>
            </Card.Body>

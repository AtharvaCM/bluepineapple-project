...
export const CricRankT20Api = async () => {
 ...
 export const CricRankOdiApi = async () => {
  ...
  export const CricRankBowlingkOdiApi = async () => {
    try {
      const url = `http://127.0.0.1:5000/api/v1/cricket/players/bowling/ranking/odi`;
      const response = await fetch(url, {
        method: "GET",
        headers: {},
      });
  ...
  export const CricRankBowlingkTestApi = async () => {
    try {
      const url = `http://127.0.0.1:5000/api/v1/cricket/players/bowling/ranking/test`;
      const response = await fetch(url, {
        method: "GET",
        headers: {},
      });
   ...
   export const CricRankBowlingkT20Api = async () => {
    try {
      const url = `http://127.0.0.1:5000/api/v1/cricket/players/bowling/ranking/t20`;
      const response = await fetch(url, {
        method: "GET",
        headers: {},
      });
